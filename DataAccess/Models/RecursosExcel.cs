...
namespace Cerberus.Sos.Accounting.DataAccess.Models
{
    ...
    public partial class RecursosExcel
    {
        public int Id { get; set; }
        public int PresupuestoId { get; set; }
        public string Ciudad { get; set; }
        public string Facility { get; set; }
        public string PlanProgramatico { get; set; }
        public string CuentaContable { get; set; }
        public string Territorio { get; set; }
        public string Contraparte { get; set; }
        public string CodigoAuditoria { get; set; }
        public string AccionNacional { get; set; }
        public string MarcoLogico { get; set; }
        ...
        public Nullable<int> RecursoExcelLoteId { get; set; }
    
        public virtual RecursosExcelLote RecursosExcelLote { get; set; }
    }
}
